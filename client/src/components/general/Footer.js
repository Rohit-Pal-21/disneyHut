      ...
      <footer className="w-full flex flex-col gap-10 sm:gap-5 sm:flex-row items-center justify-between p-4 md:p-10 lg:p-12 mb-16 mt-16 xl:mb-0">
        <div className="w-full flex justify-evenly items-center sm:flex-col sm:items-start sm:justify-center gap-2">
          ...
          <div className="text-sm text-center sm:text-left">
            ...
            <p>Made with ❤{" "}
                <a aria-label="Rohit Pal" target="_blank" rel="noreferrer" className="hover:text-white underline"
                    href="https://rohit-pal-21.github.io/">@Rohit Pal
                </a>
            </p>
            <p>Data provided by -{" "} 
        ...
        <div className="flex items-center justify-center gap-4 pb-10 sm:p-0">
            <a 
                aria-label="website"
                href="https://rohit-pal-21.github.io/"
            ...
            <a 
                aria-label="github"
                href="https://github.com/Rohit-Pal-21"
                target="_blank" rel="noreferrer"
                className="hover:text-white"
                >
            ...
            <a 
                aria-label="mail"
                href="mailto:rohitpal@gmail.com"
                target="_blank" rel="noreferrer"
                className="hover:text-white"
                >
